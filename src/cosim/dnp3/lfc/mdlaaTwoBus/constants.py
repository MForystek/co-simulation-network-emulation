...
NUM_OF_LOADS_PRIMARY_HANDLER = 2 # number of load buses attacked by the primary handler
NUM_OF_LOADS_SECONDARY_HANDLER = 0 # number of load buses attacked by the secondary handler
